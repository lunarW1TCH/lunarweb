...
import { Github, Package, FileCode } from 'lucide-astro';
...
<ProjectHeader>
  ...
  <slot slot='linkContent'>
    ...
    <BaseLink class={css({ ml: '4' })} href={frontmatter.links[2].link}>
      <FileCode />
      {frontmatter.links[2].name}
    </BaseLink>
  </slot>
</ProjectHeader>
...
### Visit the docs: [simple-2d-vectors](https://vectors.lunarweb.dev)
