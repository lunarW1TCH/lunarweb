...
Content of all **/projects** pages is written with [MDX](https://mdxjs.com/), which is a way of mixing JavaScript components (React in my case) with syntax of Markdown. Astro has a great support for it. Below you can see a fragment of how it looks like. Along with syntax highlighting which I am utilizing heavily on **/docs** pages.

<br />

```mdx
import { Github } from 'lucide-react'; // regular react component
